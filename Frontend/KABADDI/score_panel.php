...
<body>
    ...
    <div class="container2">
        ...
        <div class="buttons">
            ...
            <div class="serve-button">
                <div class="raid-btn">
                    <div class="serve-timer">
                        <label class="team-name">Start Timer </label>
                        <button class="serve">Start Raid</button>
                    </div>
            ...
            <div class="history">
                <div class="log">
                    <div class="serving">team-name raidving</div>
                    <div class="point-to-update">
                        <div class="point-to">
                            <label class="point-text">Point - 0</label>
                ...
                <div class="log">
                    <div class="serving">team-name raiding</div>
                    <div class="point-to-update">
                        <div class="point-to">
                            <label class="point-text">Point - 0</label>
                            <label class="to_team-name">to team-name</label>
