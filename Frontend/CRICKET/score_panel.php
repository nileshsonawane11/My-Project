                ...
                <div class="menu-list">
                    ...
                    <div class="menu-columns">
                        ...
                        <div class="menu">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <!-- top right arrow -->
                            <path d="M8 14.5H18V1.5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M21 4.5L18 1.5L15 4.5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            
                            <!-- bottom left arrow -->
                            <path d="M14 9.5H4V20.5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            <path d="M7 17.5L4 20.5L1 17.5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                    ...
                    <div class="menu-columns">
                        ...
                        <a href="./scoreboard.php?match_id=<?php echo $match_id; ?>"><div class="menu">
                            ...
                            <path d="M7 18V12M10 18V13M13 18V10M15 3H19V23H1V3H5M5 1H15V5H5V1Z" stroke="white" stroke-width="2"/>
                            </svg>
                            <p>Full Scoreboard</p>
                        </div></a>
                    </div>
