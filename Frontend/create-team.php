...
<body>
    ...
    <div class="container2">
        ...
        <div class="list">
            <div class="game-list" onclick="slidepage(this)">
                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M18.5401 23.655L20.6495 21.54L27.0079 27.87L24.8535 30L18.5401 23.655ZM24.7637 0C26.1525 0 27.4844 0.553123 28.4663 1.53769C29.4483 2.52226 30 3.85761 30 5.25C30 6.64239 29.4483 7.97775 28.4663 8.96231C27.4844 9.94688 26.1525 10.5 24.7637 10.5C23.375 10.5 22.0431 9.94688 21.0612 8.96231C20.0792 7.97775 19.5275 6.64239 19.5275 5.25C19.5275 3.85761 20.0792 2.52226 21.0612 1.53769C22.0431 0.553123 23.375 0 24.7637 0ZM0.437601 7.665L4.67149 3.42C4.95687 3.13876 5.34102 2.98117 5.74118 2.98117C6.14134 2.98117 6.52549 3.13876 6.81087 3.42L19.4826 16.155C20.0661 16.74 20.0661 17.685 19.4826 18.27L15.2487 22.5C15.1107 22.6424 14.9456 22.7556 14.7631 22.833C14.5807 22.9103 14.3846 22.9501 14.1865 22.9501C13.9884 22.9501 13.7924 22.9103 13.6099 22.833C13.4275 22.7556 13.2623 22.6424 13.1243 22.5L0.437601 9.795C-0.145867 9.195 -0.145867 8.25 0.437601 7.665Z" fill="black"/>
                </svg>
            ...
            <div class="game-list" onclick="slidepage(this)">
                ...
                <span class="game-name">VOLLEYBALL</span>
            </div>
            ...
            <div class="game-list" onclick="slidepage(this)">
                ...
                <span class="game-name">KABADDI</span>
            </div>
            ...
            <div class="game-list" onclick="slidepage(this)">
                ...
                <span class="game-name">KHO-KHO</span>
            </div>
            ...
            <div class="game-list" onclick="slidepage(this)">
                ...
                <span class="game-name">FOOTBALL</span>
            </div>
            ...
            <!-- <div class="game-list" onclick="slidepage(this)">
                ...
                <span class="game-name">WEIGHT-LIFTING</span>
            </div> -->
    ...
    <iframe src="./new-team.php" frameborder="0" class="cricketteam team-frame"></iframe>
    <script>
        const forvalue = "<?php echo $for; ?>";
        let next_page = document.querySelector('.team-frame');
        ...
        function slidepage(element) {
            var gameName = element.querySelector(".game-name").textContent;
    
            if(forvalue == 'team'){
                next_page.src = `./new-team.php?game=${gameName}`;
                next_page.classList.add('active');
                console.log(next_page.src);
            }else if(forvalue == 'tournament'){
                window.location.href = `./add-tournament.php?game=${gameName}`;
            }else if(forvalue == 'schedule_match'){
                window.location.href = `./select-teams.php?game=${gameName}`;
            }
        ...
        window.addEventListener("message", (event) => {
            if (event.data === "closeIframe") {
                ...
                setTimeout(()=>{
                    window.location.replace(`./create-team.php?game=${gameName}`);
                },550)
            }

            if(event.data === "goto_manage_team"){
