    ...
    if ($data['update'] != "All") {
        ...
        if (mysqli_num_rows($result) > 0) { // Check if there are rows in the result
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<div class='team'><img src='' alt='{$row['team_1']}' onerror='this.style.opacity=`0`'>{$row['team_1']}</div>";
                echo "<div class='score'>{$row['score_team_1']}</div>";
                echo "</div>";

                echo "<div class='info team-score'>";
                echo "<div class='team'><img src='' alt='{$row['team_2']}' onerror='this.style.opacity=`0`'>{$row['team_2']}</div>";
