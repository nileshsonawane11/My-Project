        ...
        <div class="header">
            ...
            <div class="profile-section">
                <div class="img-container">
                    <img id="preview" class="profile-img" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSzlxMKFGG-AjkcXZT4qWLD9xjdJVU5akjuxw&s" alt="Profile Image">
                ...
                <div class="profile-info">
                    <h1 class="profile-name">Kaustubh Sanjay Patil (Admin)</h1>
                    <div class="profile-meta">
                        ...
                        <div class="meta-item">
                            ...
                            <span>Joined on 09 Jan 2024</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="form-section">
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" value="Kaustubh" disabled>
                </div>
                <div class="form-group">
                    <label class="form-label">LAST NAME</label>
                    <input type="text" class="form-input" value="Patil" disabled>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="email" class="form-input" value="patilkaustubh123@gmail.com" disabled>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" value="Male" disabled>
                </div>
                <div class="form-group">
                    <label class="form-label">CONTACT No.</label>
                    <input type="tel" class="form-input" value="9307873351" disabled>
                </div>
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" value="Nashik" disabled>
                </div>
            </div>
        </div>
