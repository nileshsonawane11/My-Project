...
<style>
    * {
    ...
    .spinner {
        width: 50px;
        height: 50px;
        border: 4px solid rgba(209, 34, 31, 0.2);
    ...
    .start-btn:hover {
        ...
        box-shadow: 0 6px 15px rgba(209, 34, 31, 0.4);
    ...
    .plus {
        ...
        align-items: center;
        overflow: hidden;
        box-shadow: 0 4px 15px rgba(209, 34, 31, 0.4);
        background: var(--primary-red);
        transition: all 0.2s ease;
        z-index: 100;
        border-radius: 50%;
    ...
    .plus:hover {
        ...
        box-shadow: 0 6px 20px rgba(209, 34, 31, 0.5);
        background: var(--primary-red-dark);
    }
            ...
            <nav class="nav-bar">
                <div class="nav-content">
                    ...
                    <form class="d-flex" role="search" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="Get">
                        ...
                        <a href="" class="menu-bar"><svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24" focusable="false" aria-hidden="true" style="pointer-events: none; display: inherit; width: 100%; height: 100%;"><path d="M21 6H3V5h18v1zm0 5H3v1h18v-1zm0 6H3v1h18v-1z" fill="white"></path></svg></a>
